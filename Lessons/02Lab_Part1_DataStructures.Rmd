...
matrix2 <- matrix(1:20, nrow = 5, ncol = 4, byrow = TRUE) #byrow就是这行从1开始
matrix2
...
matrix1[c(12, 14)] #这个不懂

matrix1[c(12:14)] #这也不懂

matrix1[2:4, 1:3] #这个也不懂
...
#Extract a column/columns from their name 这个没懂
