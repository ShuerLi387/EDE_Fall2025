...
# Read in all CSV files starting with "EPAair 03" into a single datafcame
...
#Alternative 1
date_obj_past <- fast_strptime(str_past,"%y-%b-%d",cutoff_2000=25L) #这里24/25都可以
date_obj_past
...
#Convert to a factor, with labels and levels #我们是从这里开始的 16:10图片
